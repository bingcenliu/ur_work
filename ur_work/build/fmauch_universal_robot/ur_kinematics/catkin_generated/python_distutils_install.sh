...
echo_and_run cd "/home/bingcenliu/ur_work/src/fmauch_universal_robot/ur_kinematics"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/bingcenliu/ur_work/src/fmauch_universal_robot/ur_kinematics/setup.py" \
     \
    build --build-base "/home/bingcenliu/ur_work/build/fmauch_universal_robot/ur_kinematics" \
    install \
    --root="${DESTDIR-/}" \
