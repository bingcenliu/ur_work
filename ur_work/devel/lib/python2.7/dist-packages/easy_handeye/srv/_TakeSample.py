...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.samples.hand_world_samples.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.samples.camera_marker_samples.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
