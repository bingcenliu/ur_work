...
bool operator==(const ::easy_handeye::ComputeCalibrationResponse_<ContainerAllocator1> & lhs, const ::easy_handeye::ComputeCalibrationResponse_<ContainerAllocator2> & rhs)
{
